          ...
          <ul className="footer__social">
            <li className="footer__social-item">
              ...
              >
                ...
                >
                  <path
                    d="M5.2 1.4C8 3.5 10.9 7.7 12 9.9c1.1-2.2 4-6.4 6.8-8.5 2-1.5 5.2-2.6 5.2 1s-.4 6.2-.7 7c-.9 3.1-4 3.8-6.8 3.4 4.9.8 6.1 3.6 3.4 6.3-5.1 5.2-7.3-1.3-7.8-3-.1-.3-.2-.4-.2-.3 0-.1 0 0-.2.3-.6 1.7-2.8 8.2-7.8 3-2.7-2.7-1.4-5.5 3.4-6.3-2.8.5-5.9-.3-6.8-3.4-.2-.9-.7-6.3-.7-7C0-1.2 3.2 0 5.2 1.4Z"
                    fill="currentColor"
                  />
                </svg>
              </a>
            ...
            <li className="footer__social-item">
              ...
              >
                <svg
                  className="footer__social-codepen"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 32 32"
                >
