...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsProcessing(false);
      setErrors({
        general: 'There was an error sending your message! Please try again.',
      });
    }
  };
      ...
      {isComplete ? (
        ...
        <Page>
          ...
          <form>
            ...
            <Input
              label={`Email ${errors.email ? '<span id="emailError">(valid email required)</span>' : '*'}`}
            ...
            />
            <Input
              label={`Name ${errors.name ? '<span id="nameError">(name required)</span>' : '*'}`}
