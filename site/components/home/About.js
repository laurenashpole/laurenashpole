          ...
          <div className="about__content">
            <div className="about__desc">
              <p>
                ...
                and{' '}
                <a
                  href="http://blog.laurenashpole.com/tagged/code"
                  data-ga-click={true}
                  data-ga-category="home"
                  data-ga-text="code snippets"
                >
                  code snippets
                </a>{' '}
                on my blog.
            ...
            <div className="about__upcoming">
              <p>
                Here&apos;s a sneak peek of my next font. Sign up for updates in
                the footer and I&apos;ll let you know when it&apos;s done.
              </p>

              <div className="about__img">
                <Image
                  src={`${process.env.NEXT_PUBLIC_ASSET_BASE_URL}misc/next-font-leaves.png`}
