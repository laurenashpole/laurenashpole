    ...
    <footer className="footer">
      <div className="footer__content">
        <ul className="footer__social">
          ...
          <li className="footer__social-item">
            <a href="http://codepen.io/laurenashpole/" className="footer__social-link" data-ga-click={true} data-ga-category="footer" data-ga-action="CodePen" aria-label="CodePen">
