      ...
      <div className="footer__content">
        <ul className="footer__social">
          <li className="footer__social-item">
            <a href="https://twitter.com/laurenashpole" className="footer__social-link" data-ga-click={true} data-ga-category="footer" data-ga-action="Twitter" aria-label="Twitter">
          ...
          <li className="footer__social-item">
            <a href="https://www.pinterest.com/laurenashpole/" className="footer__social-link" data-ga-click={true} data-ga-category="footer" data-ga-action="Pinterest" aria-label="Pinterest">
          ...
          <li className="footer__social-item">
            <a href="https://github.com/laurenashpole" className="footer__social-link" data-ga-click={true} data-ga-category="footer" data-ga-action="Github" aria-label="Github">
          ...
          <li className="footer__social-item">
            <a href="https://codepen.io/laurenashpole/" className="footer__social-link" data-ga-click={true} data-ga-category="footer" data-ga-action="CodePen" aria-label="CodePen">
