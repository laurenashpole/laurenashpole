  ...
  return (
    <div className="order">
      <div>
        ...
        <p>If you want web fonts and additional characters (where applicable), don&apos;t forget to download the commercial files before leaving this page. They will also be emailed as attachments to {order.payer.email_address}. If you have any questions about your purchase, visit the <Link href="/fonts/licensing"><a data-ga-click="true" data-ga-category="confirm">licensing details</a></Link> or the <Link href="/fonts/eula"><a data-ga-click="true" data-ga-category="confirm">EULA</a></Link> or email me at <a href={`mailto:${process.env.NEXT_PUBLIC_EMAIL}`} title={process.env.NEXT_PUBLIC_EMAIL}>{process.env.NEXT_PUBLIC_EMAIL}</a></p>
      </div>
